...
class SearchBar extends React.Component {
  ...
  handleSubmit(event) {
      ...
      fetch("https://aut-cise-api.herokuapp.com/search/" + encodeURIComponent(this.state.query))
  ...
  render() {
    return (
      <div>
        ...
        {this.state.alertBox}
        <input type="text" placeholder="Search" onChange={this.handleChange} name="Search" className="extendedbar"></input>
      </div>
    );
  }
}
